...
const stats = ref<SQ[]>([
  ...
  { id: '3', supplier: 'ZZ标准件有限公司', total_batches: 30, pass_batches: 28, pass_rate: 93.3, repeat_issues: 2, last_inspection: '2025-01-14' },
  { id: '4', supplier: 'AA铸件有限公司', total_batches: 12, pass_batches: 9, pass_rate: 75, repeat_issues: 3, last_inspection: '2025-01-10' }
])
const s = reactive({ supplier: '' })
const sc: FormColumnItem[] = [{ type: 'input', label: '供应商', field: 'supplier' } as any]
...
const fd = computed(() => stats.value.filter((r) => !s.supplier || r.supplier.includes(s.supplier)))
