...
const empCols: TableColumnItem<any>[] = [
  ...
  { label: '状态', width: 60, slotName: 'status', align: 'center' }
]
...
const attCols: TableColumnItem<any>[] = [
...
const schCols: TableColumnItem<any>[] = [
  { prop: 'team', label: '班组', width: 80 },
  { label: '班次', width: 60, slotName: 'shift', align: 'center' },
  { prop: 'members', label: '成员', minWidth: 180 },
  { prop: 'leader', label: '班组长', width: 80 }
]
</script>
