  ...
  <gi-page-layout :bordered="true">
    <el-tabs v-model="tab">
      ...
      <el-tab-pane label="成本核算" name="cost">
        <el-row :gutter="16"
          ><el-col :span="8" v-for="c in costs" :key="c.title"
            ><el-card shadow="hover"
              ><div class="cost-title">{{ c.title }}</div>
              <div class="cost-value">{{ c.value.toLocaleString() }} 元</div></el-card
            ></el-col
          ></el-row
        >
      </el-tab-pane>
      <el-tab-pane label="财务报表" name="report">
        <el-card header="月度经营概览"
          ><el-descriptions :column="3" border
            ><el-descriptions-item label="营业收入">¥850,000</el-descriptions-item
            ><el-descriptions-item label="营业成本">¥620,000</el-descriptions-item><el-descriptions-item label="毛利">¥230,000</el-descriptions-item
            ><el-descriptions-item label="应收余额">¥310,000</el-descriptions-item
            ><el-descriptions-item label="应付余额">¥180,000</el-descriptions-item
            ><el-descriptions-item label="净利润">¥150,000</el-descriptions-item></el-descriptions
          ></el-card
        >
      </el-tab-pane>
    </el-tabs>
...
const payables = ref([
  ...
  { id: '3', code: 'AP20250105003', supplier: 'ZZ标准件有限公司', amount: 30000, paid: 30000, balance: 0, due_date: '2025-01-20', status: 'paid' }
])
const payCols: TableColumnItem<any>[] = [
...
const costs = [
  { title: '本月材料成本', value: 380000 },
  { title: '本月人工成本', value: 150000 },
  { title: '本月制造费用', value: 90000 }
]
</script>
<style scoped>
.cost-title {
