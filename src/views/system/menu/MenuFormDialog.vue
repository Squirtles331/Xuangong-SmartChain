    ...
    <el-dialog v-model="iconDialogVisible" title="选择图标" width="700px" append-to-body :lock-scroll="false">
      ...
      <div class="icon-grid">
        <div
          ...
          :key="name"
          class="icon-item"
          :class="{ active: formData.icon === name }"
...
const commonIcons = ref([
  'HomeFilled', 'Setting', 'User', 'Lock', 'Key', 'List', 'Grid', 'Menu',
  'Document', 'Folder', 'FolderOpened', 'Edit', 'Delete', 'Plus', 'Minus',
  'Check', 'Close', 'Search', 'Refresh', 'Upload', 'Download', 'Share',
  'Message', 'Bell', 'Warning', 'InfoFilled', 'CircleCheck', 'Clock',
  'Calendar', 'Picture', 'VideoCamera', 'Monitor', 'DataAnalysis',
  'TrendCharts', 'Histogram', 'PieChart', 'Connection', 'Link', 'Switch',
  'Operation', 'Tools', 'Platform', 'Management', 'Promotion', 'Collection',
  'Tickets', 'Postcard', 'Box', 'Goods', 'ShoppingBag', 'ShoppingCart',
  'PriceTag', 'Coin', 'Money', 'Wallet', 'CreditCard', 'BankCard',
  'MapLocation', 'Position', 'LocationFilled', 'Aim', 'Compass',
  'ChatDotRound', 'ChatLineRound', 'ChatLineSquare', 'ChatRound',
  'Service', 'Headset', 'Phone', 'PhoneFilled', 'MessageBox', 'View',
  'Hide', 'Unlock', 'Finished', 'More', 'MoreFilled', 'Star', 'StarFilled',
  'Thumb', 'Pointer', 'Flag', 'Sell', 'Filter', 'Sort', 'Rank', 'Guide',
  'Opportunity'
])
