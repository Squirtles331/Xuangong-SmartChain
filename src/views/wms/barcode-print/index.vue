...
const cols:TableColumnItem<any>[]=[{type:'selection',minWidth:50},{prop:'barcode',label:'条码',minWidth:180},{prop:'code',label:'物料编码',minWidth:170},{prop:'name',label:'物料名称',minWidth:160},{prop:'lot',label:'批号',minWidth:160},{prop:'qty',label:'库存',minWidth:80,align:'center'}]
