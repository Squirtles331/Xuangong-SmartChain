    ...
    <el-tabs v-model="tab">
      <el-tab-pane label="模具约束" name="mold">
        ...
        <gi-table :columns="moldCols" :data="molds" border stripe size="small">
          <template #actions="{ row }"><gi-button type="edit" @click="openEdit('mold',row)" /><gi-button type="delete" @click="del('mold',row.id)" /></template>
        </gi-table>
      </el-tab-pane>
      <el-tab-pane label="刀具约束" name="tool">
        ...
        <gi-table :columns="toolCols" :data="tools" border stripe size="small">
          <template #actions="{ row }"><gi-button type="edit" @click="openEdit('tool',row)" /><gi-button type="delete" @click="del('tool',row.id)" /></template>
        </gi-table>
      </el-tab-pane>
      <el-tab-pane label="人员技能约束" name="skill">
        ...
        <gi-table :columns="skillCols" :data="skills" border stripe size="small">
          <template #actions="{ row }"><gi-button type="edit" @click="openEdit('skill',row)" /><gi-button type="delete" @click="del('skill',row.id)" /></template>
        </gi-table>
      </el-tab-pane>
    </el-tabs>
