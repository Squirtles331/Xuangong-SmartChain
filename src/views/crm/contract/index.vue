<template>
  <gi-page-layout :bordered="true">
    <template #header><SearchSetting :columns="allSearchColumns" storage-key="contract-search" @update:visible-fields="onSearchFieldsChange">
    ...
    <gi-dialog v-model="vis" :footer="true" :on-before-ok="submit" :title="mode === 'add' ? '新增合同' : '编辑合同'" width="650px">
      <SearchSetting :columns="allSearchColumns" storage-key="contract-search" @update:visible-fields="onSearchFieldsChange">
