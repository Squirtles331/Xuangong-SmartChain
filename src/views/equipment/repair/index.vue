<template>
  <gi-page-layout :bordered="true">
    <template #header><SearchSetting :columns="allSearchColumns" storage-key="repair-search" @update:visible-fields="onSearchFieldsChange">
    ...
    <gi-dialog v-model="vis" :footer="true" :on-before-ok="submit" :title="mode === 'add' ? '新增维修工单' : '编辑维修工单'" width="600px">
      <SearchSetting :columns="allSearchColumns" storage-key="repair-search" @update:visible-fields="onSearchFieldsChange">
