...
onMounted(() => {
  if (chartRef.value) {
    ...
    c.setOption({
      ...
      series: [
        { name: 'OEE', type: 'line', data: [75, 76, 78, 77, 79, 78.5], itemStyle: { color: '#409eff' } },
        { name: '利用率', type: 'line', data: [82, 84, 85, 83, 86, 85.2], itemStyle: { color: '#67c23a' } },
        { name: '性能', type: 'line', data: [90, 91, 92, 91, 93, 92.1], itemStyle: { color: '#e6a23c' } },
        { name: '质量', type: 'line', data: [97, 98, 97.5, 98.2, 98.5, 98.3], itemStyle: { color: '#f56c6c' } }
      ]
    })
  }
})
