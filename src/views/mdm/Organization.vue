  ...
  <gi-page-layout :bordered="true">
    <div class="mdm-layout">
      ...
      <div class="mdm-form">
        ...
        <gi-form v-else v-model="cur" :columns="orgCols" :label-width="120"
          ><template #footer><el-button type="primary" @click="save">保存</el-button></template></gi-form
        >
      </div>
    </div>
  </gi-page-layout>
        ...
        children: [
          {
            ...
            type: 'plant',
            children: [
              { id: '4', name: '机加工一车间', type: 'workshop' },
