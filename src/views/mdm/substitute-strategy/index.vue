...
const keywordFields = ['code', 'primaryMaterial', 'substituteMaterial']
...
const overviewCards = computed(() => {
  ...
  return [
    { label: '替代料策略总量', value: records.value.length, desc: '当前已纳入静态主数据基线的对象数量' },
