...
const keywordFields = ['code', 'productCode', 'routingName', 'version']
...
const records = ref<MasterDataRow[]>([
  ...
  },
  {
    'id': 'RT-003',
    'code': 'RT-1888-V0.9',
    'productCode': 'FG-ASSY-1888',
    'routingName': '真空模组试制路线',
    'version': 'V0.9',
    'operationCount': 5,
    'source': 'PLM',
    'status': 'draft'
...
const overviewCards = computed(() => {
  ...
  return [
    { label: '工艺路线总量', value: records.value.length, desc: '当前已纳入静态主数据基线的对象数量' },
...
function createDefaultFormModel() {
  return { id: '', code: '', productCode: '', routingName: '', version: 'V1.0', operationCount: 0, source: 'PLM', status: 'draft' }
}
