...
const keywordFields = ['code', 'name', 'operation']
...
const overviewCards = computed(() => {
  ...
  return [
    { label: '工艺参数总量', value: records.value.length, desc: '当前已纳入静态主数据基线的对象数量' },
...
function createDefaultFormModel() {
  return { id: '', code: '', name: '', operation: '', unit: '', range: '', status: 'active' }
}
